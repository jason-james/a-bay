...
//checks if the value entered is larger than latest bid for that item, if not, it shows an alert
    if ($bid_amount > $queryzresult) {
...
//        redirect_to('/public/html/product_listing.php?item_id=' . $item_id . "&listing_id=" . $listing_id);
        $low_bid_mess = "Your bid amount is too low, please enter a higher value. Hit the back button to continue";
