...
<div class="container">
    <div class="subject new">
        ...
        <form action="insert_item_info.php" method="post" enctype = multipart/form-data> <!--// action is where the form will be submitted-->
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Create listing from previous items</h6>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01">Items Sold</label>
                        </div>
                        <select class="custom-select" id="inputGroupSelect01" name="past_item" >
                            ...
                            <?php while($item = mysqli_fetch_assoc($items_sold)) {
                                ...
                                <option value="<?php echo htmlspecialchars(json_encode($item))?>"> <?php echo $item['item_name']?> </option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="card my-4">
                <div class="card-body">
                    ...
                    <dl>
                        <dt>Size</dt>
                        <input type="text" name="size" class="form-control" placeholder="Large, 20cm x 30cm x 10cm, etc...">
                    </dl>
                </div>
            </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <dd><input type="text" class="form-control" name="starting_price" required/></dd>
                        </div>
                        <div class="form-group row">
                            <label class="col-2 col-form-label">Reserve Price (£)</label>
                            <dd><input type="text" class="form-control" name="reserve_price" value="" required/></dd>
                        </div>
                        <div class="form-group row">
                            <label class="col-2 col-form-label">Buy Now Price (£)</label>
                            <dd><input type="text" class="form-control" name="buy_now_price" value="" required/></dd>
                        </div>
                        <div class="form-group row">
