...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require("../../private/register_functions.php");
}
?>
        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card h-75 my-5">
                <div class="card-body">
                    ...
                    <!-- After form is submitted, call registration.php with POST method which then includes the registration functions for us-->
                    <form action="registration.php" method="post" autocomplete="off">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="surName" placeholder="Surname" name="lastname" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputCountry" class="form-control" name="country" selected="United Kingdom" required>
