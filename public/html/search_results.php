                ...
                <div class="col">
                    <div class="card h-50">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a href="#"><img class="card-img-top" src="https://media.karousell.com/media/photos/products/2018/10/06/corsair_gs600_80plus_psu_1538780922_81e254d1.jpg" height="160" width="125" alt=""></a>
                                    </div>
                                    <div class="col">
                                        <h4 class="card-title">
                                            <a href="product_listing.php">Corsair GS600+ 600W PSU</a>
                                        </h4>
                                        <h5>$44.99</h5>
                ...
                <div class="col">
                    <div class="card h-50">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <a href="#"><img class="card-img-top" src="http://placehold.it/150x125" alt=""></a>
                                </div>
                                <div class="col">
                                    <h4 class="card-title">
                                        <a href="#">Item 2</a>
